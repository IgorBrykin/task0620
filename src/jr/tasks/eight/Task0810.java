...
Измерить, сколько времени занимает
10 тысяч вызовов get для каждого списка.
Метод getGetTimeInMs должен вернуть
время своего исполнения в миллисекундах.
...
7. Метод getGetTimeInMs должен вернуть время в миллисекундах,
...
public class Task0810 {
    ...
    public static long getGetTimeInMs(List list) {
        ...
        Date after = new Date();
        long msDelay = after.getTime()-before.getTime();
        return msDelay;
